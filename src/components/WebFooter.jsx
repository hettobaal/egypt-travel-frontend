        ...
        <>
            <footer className='max-w-[1336px] w-full mx-auto lg:px-10 md:px-8 sm:px-6 px-4 flex flex-col xl:gap-y-24 md:gap-y-20 gap-y-8 sm:mt-4 mt-4 md:mb-6 mb-4'>
                <div className='w-full flex flex-col lg:gap-y-16 sm:gap-y-8 gap-y-6 '>
                    <div className='w-full flex xl:flex-row flex-col  justify-between xl:items-start items-start md:gap-x-10 '>
                        <div className='max-w-md  flex flex-col sm:gap-y-6 gap-y-4'>
                            ...
                            <div className=''>
                                ...
                                <span className='grid lg:grid-cols-5  grid-cols-5   gap-x-4 gap-y-4 items-center  mt-4'>
                                    <Link
                                        prefetch={false}
                        ...
                        <div className='xl:w-[65%] w-full flex flex-col gap-y-8  xl:ml-8'>
                            <ul className=' w-full grid md:grid-cols-3 grid-cols-2 gap-x-2  gap-y-5  md:pt-16 pt-8 '>
                                <li className='w-full'>
                                    ...
                                    <ul className='flex flex-col gap-y-2 mt-4'>
                                        ...
                                        <li className='flex flex-col gap-y-4 gap-x-4 mt-1'>
                                            <Link
                                                target='_blank'
