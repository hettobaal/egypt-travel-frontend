...
import { approveBooking, cancelBooking, deleteBooking, DeleteContactMessage, DeleteTour } from "@/lib/siteApis";
...
function ViewContacts({ userMessages }) {
    ...
    const renderCell = React.useCallback((userMessages, columnKey) => {

        const cellValue = userMessages[columnKey];
        const date = userMessages?.date;
                ...
                return (
                    <div className="relative flex flex-col items-start gap-2">
                        <span className="text-lg text-danger cursor-pointer active:opacity-50">
                            <Button
                                onClick={() => Delete(userMessages?._id)}
