...
import { addSubCategoryMetaData } from '@/lib/siteApis'
...
function CreateSubCategoryMetaData({ data }) {
    ...
    const onSubmit = async (data) => {
        setLoader(true)
        const res = await addSubCategoryMetaData(data)
        setLoader(false)
...
export default CreateSubCategoryMetaData;
